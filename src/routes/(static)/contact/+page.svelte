  ...
  <div class="flex min-h-screen w-full px-8 py-24 justify-center">
    ...
    <div class="isolate px-100 py-100 sm:py-200 lg:px-500">
        ...
        <div class="mx-auto mt-16 max-w-xl sm:mt-20">
          ...
          <div class="mt-10">
            <button on:click={contact} class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Let's talk</button>
          </div>
          <br>
