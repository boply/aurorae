...
<div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 self-center">
    ...
    <form action="get_response.php" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
      ...
      <div class="mt-10">
        <button type="submit" class="btn btn-primary btn-block">Let's talk</button>
      </div>
    </form>   
  </div>  
</div>
